...
import 'package:car_app/features/auth/presentation/widgets/auth_section.dart';
      ...
      body: Padding(
        ...
        child: CustomScrollView(
          slivers: [
            ...
            SliverToBoxAdapter(child: CustomTitleAuthSection()),
            SliverToBoxAdapter(child: SizedBox(height: res.rh(20))),
            ...
            SliverToBoxAdapter(child: SizedBox(height: res.rh(40))),
            SliverToBoxAdapter(child: DontHaveAccount()),
            SliverToBoxAdapter(child: SizedBox(height: res.rh(40))),
          ],
        ),
      ),
